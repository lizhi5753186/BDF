...
namespace Bdf.Tests.Events.Bus
{
    public class ActionBasedEventHandlerTest : EventBusTestBase
    {
        ...
        public void Should_Call_Action_On_Event_With_Correct_Source()
        {
            ...
            EventBus.Trigger(this, new MySimpleEventData { Value = 3 });
            EventBus.Trigger(this, new MySimpleEventData { Value = 4 });
        ...
        public void Should_Call_Handler_With_Non_Generic_Trigger()
        {
            ...
            EventBus.Trigger(typeof(MySimpleEventData), this, new MySimpleEventData { Value = 1 });
            EventBus.Trigger(typeof(MySimpleEventData), this, new MySimpleEventData { Value = 2 });
            EventBus.Trigger(typeof(MySimpleEventData), this, new MySimpleEventData { Value = 3 });
            EventBus.Trigger(typeof(MySimpleEventData), this, new MySimpleEventData { Value = 4 });
