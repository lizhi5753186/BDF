...
namespace Bdf.Tests.Dependency
{
    ...
    {
        [Fact]
        public void Should_Sucess_Circular_Property_Injection_Transient()
        {
            Initialize_Test(DependencyLifeStyle.Transient);

            var obj1 = LocalIocManager.Resolve<MyClass1>();
            obj1.Obj2.ShouldNotBeNull();
            obj1.Obj3.ShouldNotBeNull();
            obj1.Obj2.Obj3.ShouldNotBeNull();
