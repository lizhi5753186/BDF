...
{
    /// <summary>
    /// Defines a cache interface that can be store and get items by key
    /// </summary>
    public interface ICache : IDisposable
    {
        ...
        /// Default time: 60 minutes. Can be changed by configuration.
        /// </summary>
        ...
        /// <summary>
        /// Get an item from the cache or null if not found
        /// </summary>
        /// <param name="key">Key</param>
