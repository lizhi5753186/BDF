...
namespace Bdf.Uow
{
    ...
    public interface IActiveUnitOfWork
    {
        ...
        /// <summary>
        /// Get if unit of work is transactional
        /// </summary>
        ...
        /// <summary>
        /// Save all changes until now in this unit of work
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter names. <see cref="BdfDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter name. <see cref="BdfDataFilters"/></param>
        ...
        /// </summary>
        /// <param name="filterName">Name of the filter. <see cref="BdfDataFilters"/> for standard filters.</param>
